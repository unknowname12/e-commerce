<x-layouts.main title="Sign in">
    <div class="flex min-h-screen justify-center items-center">
        <div class="border p-[3rem] rounded-lg">
            <p class="py-[1rem] font-semibold text-2xl">Sign up new account</p>
            <form action="{{ route('auth.signup.store') }}" method="POST">
                ...
                <div class="flex flex-col gap-2 justify-center items-start w-full">
                    <div class="flex flex-col justify-start items-start w-full">
                        ...
                        <input class="w-full border-gray-300 bg-gray-200/60 rounded-lg" placeholder="Your Name" type="text" name="name" id="name">
                    ...
                    <div class="flex flex-col justify-start items-start w-full">
                        ...
                        <input class="w-full border-gray-300 bg-gray-200/60 rounded-lg" placeholder="Your Password Confirmation" type="password" name="password_confirmation" id="password_confirmation">
                        <x-error :messages="$errors->get('password_confirmation')"/>
                    </div>
                    <div class="flex flex-col justify-start items-start w-full gap-[1rem]">
                        <button class="border rounded-lg w-full py-2 bg-yellow-600 hover:bg-yellow-500 font-semibold text-white" type="submit">Sign up</button>
                        <span class="text-center">Have an account? continue on <a href="{{ route('auth.signin') }}" class="hover:text-yellow-600 underline transition-all">Signin</a>.</span>
                    </div>
                </div>
            </form>
        </div>
